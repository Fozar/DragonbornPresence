...
void MainMenuState::entry()
{
	...
	dragonborn_presence_namespace::UpdatePresence("Main Menu", nullptr);
}
...
void EditingCharacterState::entry()
{
	...
	dragonborn_presence_namespace::UpdatePresence("Editing character", nullptr);
}
...
#pragma region ReceiveEvent
	...
	EventResult DiscordMenuEventHandler::ReceiveEvent(
		MenuOpenCloseEvent * evn, EventDispatcher<MenuOpenCloseEvent> * dispatcher)
	{
